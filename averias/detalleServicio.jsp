        ...
        <div id="wrapper">
            ...
            <div class="content">
                ...
                <form name="ActualizarServicio" action="/averias/actualizarServicio" method="get">
                    ...
                    <table>
                        <tr><td>Fecha Instalacion:</td><td><input type="text" name="fechaInst" value="<%= servicio.fechaInst %>"/></td></tr>
                        <tr><td>Descripcion:</td><td><input type="text" name="direccion" value="<%= servicio.direccion %>"/></td></tr>
						<tr><td>Region:</td>
						<td>
